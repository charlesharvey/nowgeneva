...
if (function_exists('add_theme_support'))
{
    ...
    add_image_size('medium', 800, 400, true); // Medium Thumbnail
    ...
    add_image_size('rectangle', 600, 300, true); // Custom Thumbnail Size call using the_post_thumbnail('custom-size');
...
function get_posts_from_shop_id($shop_id) {
    ...
    $shop_posts = new WP_Query( array( 'post_type' => 'post', 'post__in' => $post_ids ) );
    wp_reset_query();
    return $shop_posts;
...
function get_post_id_from_wpdb($row){
